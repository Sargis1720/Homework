...
# Երկու տարբերակն էլ լավ էր։ Բայց մի խնդիր կա, պատկերացրու 100x100 մատրիցի հետ գործ ունես ու պետք ա նույն գործողությունը
# անես։ Հաստատ ամենահարմար տարբերակը չի ձեռքով ստեղծել էդ մատրիցը :) Էնպես որ փորձիր a-ն ստեղծել ցիկլի միջոցով։
